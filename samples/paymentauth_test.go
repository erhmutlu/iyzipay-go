...
func TestMarketplacePaymentAuth(t *testing.T) {
	...
	basketItem1 := model.BasketItem{Id: "BI101", Name: "Binocular", Category1: "Collectibles", Category2: "Accessories", ItemType: "PHYSICAL", Price: 0.3, SubMerchantKey: nullable.NewNullableString("ha3us4v5mk2652kkjk5728cc4407an"), SubMerchantPrice: nullable.NewNullableFloat(0.27)}
	p := basketItem1.ToPKIRequest()
	println(p)
	basketItem2 := model.BasketItem{Id: "BI102", Name: "Game code", Category1: "Game", Category2: "Online Game Items", ItemType: "VIRTUAL", Price: 0.5, SubMerchantKey: nullable.NewNullableString("ha3us4v5mk2652kkjk5728cc4407an"), SubMerchantPrice: nullable.NewNullableFloat(0.42)}
	basketItem3 := model.BasketItem{Id: "BI103", Name: "Usb", Category1: "Electronics", Category2: "Usb / Cable", ItemType: "PHYSICAL", Price: 0.2, SubMerchantKey: nullable.NewNullableString("ha3us4v5mk2652kkjk5728cc4407an"), SubMerchantPrice: nullable.NewNullableFloat(0.18)}
